Shader "Custom/ToonWater"
{
	Properties
	{
		...
		_EdgeFoamColour("Foam Edge Colour", Color) = (1,1,1,1)
		_EdgeFoamThresh("Edge Foam Threshold", Float) = .5
		...
		SubShader
	{
		...
		//return rippleColour;
		float edgeFoamFade = step(_FoamCutoff, edgeFoam);

		float4 finalColWithEdgeF = lerp(finalColor, _EdgeFoamColour, edgeFoamFade);

		float4 finalColorWRipple = alphaBlend(rippleColour, finalColWithEdgeF);
